...
//		Gimbal_Armor_Cal(RC_Ctl.rc, RC_Ctl.mouse);//和PC通讯相关，暂时注释
		break;

	case Gimbal_BigBuf_Mode:
	case Gimbal_SmlBuf_Mode:
//		Gimbal_Buff_Cal(RC_Ctl.rc, RC_Ctl.mouse);//和PC通讯相关，暂时注释
		break;
...
extern TaskHandle_t RCReceive_task_handle;//任务句柄
extern uint8_t Remote_Receive_Flag;//任务句柄
