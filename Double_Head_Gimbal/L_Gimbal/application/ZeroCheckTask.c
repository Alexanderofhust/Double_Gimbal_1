...
*返 回 值: 无
**********************************************************************************************************/
extern float INS_Gyro_y;
extern float INS_Gyro_x ;
extern float INS_Gyro_z ;
extern float INS_Gyro_xz ;
void ZeroCheck_cal(void)
{
	...
	pitch_motor_temp = Sentry.motor_pn*(Sentry.Pitch_init-Gimbal.Pitch.Motor)/8192.0f*360.0f;
	...
	INS_Gyro_xz = - arm_sin_f32(pitch_motor_temp/180.0f * 3.14159f )* INS_Gyro_x 
	- arm_cos_f32(pitch_motor_temp/180.0f * 3.14159f)*INS_Gyro_z;
	
	Gimbal.Yaw.Gyro = INS.YawTotalAngle;
    //Gimbal.Yaw.AngularSpeed = INS.YawSpeed;
	Gimbal.Yaw.AngularSpeed = INS_Gyro_xz;
	Gimbal.Yaw.Motor = ZeroCheck(&ZeroCheck_Yaw,YawMotorReceive,Position);
	Gimbal.Yaw.MotorTransAngle = (YawMotorReceive-Sentry.Yaw_init)/8192.0f*360.0f;
...
void ZeroCheck_Init(void)
{
	...
	ZeroCheck_Yaw_speed.CountCycle=65535;
